...
public class MessageService : IMessageService
{
    ...
    {
        var queueSetting = _queueSettings.FirstOrDefault(q => q.Name == queueName);
    ...
    public List<string> ConsumeMessages(string queueName)
    {
        ...
        try
        {
            ...
            channel.ExchangeDeclare(queueSetting.Exchange, ExchangeType.Fanout);

            channel.QueueBind(
                queue: queueName,
                exchange: queueSetting.Exchange,
                routingKey: string.Empty
            );
